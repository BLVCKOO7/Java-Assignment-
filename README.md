...
1.public class Question1_StudentGrading {
...
2.public class Question2_LabAllocation {
    public static void main(String[] args) {
        Scanner input = new Scanner(System.in);
...
3.public class Question3_DiscountPolicy {
    public static void main(String[] args) {
        Scanner input = new Scanner(System.in);
        int choice;
...
4.public class Question4_CompareNumbers {
    public static void main(String[] args) {
        Scanner input = new Scanner(System.in);
        char again;
